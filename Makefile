...
deploy-sepolia:
	@forge script script/DeployRaffle.s.sol:DeployRaffle --rpc-url $(SEPOLIA_RPC_URL) --account deployer-eth-sepolia --broadcast --verify --etherscan-api-key $(ETHERSCAN_SEPOLIA_API_KEY) -vvvv
