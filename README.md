...
* ****Optimized Storage Access****: Frequently used configuration values are stored as `immutable`, while dynamic state variables are updated only when necessary to
