...
```
### Core Components 
* **Raffle Contract (Raffle.sol)**: The central component responsible for accepting entries, maintaining the raffle state, tracking players, requesting randomness, selecting the winner,
